...
window.onload= function unity(){
    let products = items.map((item,index) => {
       ...
       return `
               ...
               <td><button value =${index} data-edit>edit</button></td>
...
// 2 functions and one is called in a function its called a nested function
